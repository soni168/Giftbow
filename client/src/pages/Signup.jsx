    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#FFF8F5] dark:bg-[#0f0f0f]">
      <div className="w-full max-w-md bg-white dark:bg-[#242424] rounded-3xl shadow-lg p-8 border border-coral/10 dark:border-white/5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1 block">Name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1 block">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1 block">Password</label>
            <input
              type="password"
              value={password}
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link to="/login" className="text-coral font-bold hover:underline">Login karo</Link>
        </p>
      </div>
    </div>
  );
